...
# The draft three-way mechanism-rule tests that lived here were SUPERSEDED when
# the rule was rewritten to the preregistered four-way specification (§5.1/§9).
# They exercised an API that no longer exists by design. Their replacement, far
# broader, is tests/test_mechanism_rule.py.
